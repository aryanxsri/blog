...
// .wrangler/tmp/bundle-T3XfYa/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\cohort\\blog\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-T3XfYa/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-T3XfYa/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.put("/api/v1/blog", (c) => {
  return c.text("Hello Hono4!");
});
app.get("/api/v1/blog", (c) => {
  return c.text("Hello Hono5!");
});
app.get("/api/v1/blog/blog", (c) => {
  return c.text("Hello Hono6!");
});
var src_default = app;
