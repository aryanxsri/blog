...
// .wrangler/tmp/bundle-RHjqXM/checked-fetch.js
  ...
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var yi = Fe((ze) => {
      ...
      function mi(e, t, r, n, i) {
        return t = +t, r = r >>> 0, i || di(e, t, r, 4, 34028234663852886e22, -34028234663852886e22), We.write(e, t, r, n, 23, 4), r + 4;
      }
      ...
      function fi(e, t, r, n, i) {
        return t = +t, r = r >>> 0, i || di(e, t, r, 8, 17976931348623157e292, -17976931348623157e292), We.write(e, t, r, n, 52, 8), r + 8;
      }
    ...
    var Yi = Fe((Rh, nl) => {
      nl.exports = { name: "@prisma/engines-version", version: "5.19.1-2.69d742ee20b815d88e17e54db4a2a7a3b30324e3", main: "index.js", types: "index.d.ts", license: "Apache-2.0", author: "Tim Suchanek <suchanek@prisma.io>", prisma: { enginesVersion: "69d742ee20b815d88e17e54db4a2a7a3b30324e3" }, repository: { type: "git", url: "https://github.com/prisma/engines-wrapper.git", directory: "packages/engines-version" }, devDependencies: { "@types/node": "18.19.34", typescript: "4.9.5" }, files: ["index.js", "index.d.ts"], scripts: { build: "tsc -d" } };
    });
    var Zi = Fe(() => {
      "use strict";
      f();
    ...
    function Va(e) {
      let t = { color: Mi[$a++ % Mi.length], enabled: Pt.enabled(e), namespace: e, log: Pt.log, extend: () => {
        ...
        if (n.length !== 0 && mr.push([o, ...n]), mr.length > Ua && mr.shift(), Pt.enabled(o) || i) {
...
`);
    ...
    A.sine = A.sin = function() {
      var e, t, r = this, n = r.constructor;
      return r.isFinite() ? r.isZero() ? new n(r) : (e = n.precision, t = n.rounding, n.precision = e + Math.max(r.e, r.sd()) + k, n.rounding = 1, r = dl(n, yo(n, r)), n.precision = e, n.rounding = t, O(Te > 2 ? r.neg() : r, e, t, true)) : new n(NaN);
    };
    ...
    var Eo = { bold: pr, red: Ye, green: Si, dim: dr, enabled: true };
    var at = { write(e) {
      e.writeLine(",");
    } };
    f();
...
`);
    ...
    function Po(e) {
      ...
      return e instanceof ve ? new z(`Prisma.${e._getName()}`) : st(e) ? new z(`prisma.${no(e.modelName)}.$fields.${e.name}`) : Array.isArray(e) ? Xl(e) : typeof e == "object" ? xo(e) : new z(Object.prototype.toString.call(e));
    }
    function Xl(e) {
      let t = new lt();
      for (let r of e)
...
Prisma Accelerate has built-in connection pooling to prevent such errors: https://pris.ly/client/error-accelerate`), r;
    ...
    m();
    var pu = _e($i());
    var du = { red: Ye, gray: Di, dim: dr, bold: pr, underline: Ri, highlightSource: (e) => e.highlight() };
    var mu = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
`);
    ...
    function dt(e) {
      ...
      return typeof $getTemplateParameters < "u" ? r = $getTemplateParameters(e, t) : r = fu(e), gu(r, t);
    }
    function Do(e, t, r, n) {
    ...
    function _o({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
      ...
      for (let l of Object.values(o)) {
        ...
        Tu(e, l.needs) && s.push(Au(l, fe(e, s)));
      }
    ...
    function Ru(e) {
      let t = new me(), r = (n, i) => t.getOrCreate(n, () => i.has(n) ? [n] : (i.add(n), e[n] ? e[n].needs.flatMap((o) => r(o, i)) : [n]));
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`, n) : new J(`error: Environment variable not found: ${s.fromEnvVar}.`, n);
    ...
    d();
    m();
    var os = { "@prisma/debug": "workspace:*", "@prisma/engines-version": "5.19.1-2.69d742ee20b815d88e17e54db4a2a7a3b30324e3", "@prisma/fetch-engine": "workspace:*", "@prisma/get-platform": "workspace:*" };
    f();
    c();
    p();
    d();
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    function Vr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
      ...
      for (let h of t)
        Ur(h, a, s);
      let { message: l, args: u } = Dr(a, r), g = dt({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: u });
    ...
    function bs({ modelName: e, action: t, args: r, runtimeDataModel: n, extensions: i, callsite: o, clientMethod: s, errorFormat: a, clientVersion: l, previewFeatures: u, globalOmit: g }) {
      ...
      return { modelName: e, action: mc[t], query: nr(r, h) };
    }
    function nr({ select: e, include: t, ...r } = {}, n) {
      let i;
      return n.isPreviewFeatureOn("omitApi") && (i = r.omit, delete r.omit), { arguments: Ps(r, n), selection: fc(e, t, i, n) };
    }
    function fc(e, t, r, n) {
...
${n}`;
    ...
    function ea(e) {
      class t {
        ...
        _createItxClient(n) {
          return Bt(fe(No(this), [te("_appliedParent", () => this._appliedParent._createItxClient(n)), te("_createPrismaPromise", () => Wn(n)), te(Bc, () => n.id), et(Is)]));
        }
        $transaction(n, i) {
          let o;
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\cohort\\medium\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
      ...
      "inlineSchemaHash": "6e530dd3948b231212070c5e35d429e3d2a0da9cd3cb57bb738701fd1eec695e",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-RHjqXM/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-RHjqXM/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
